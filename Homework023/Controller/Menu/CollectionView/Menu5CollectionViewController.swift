...
class Menu5CollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        MenuController.shared.fetchMenuRecords(page) { result in
            ...
            case .failure(let error):
                self.displayError(error, title: "Failed to Fetch Menu5 Items")
            }
        }
        configureCellSize()
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.menu5DrinkNameLabel.text = menuRecord.fields.name
        cell.menu5DrinkMidPriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.midPrice!)
        cell.menu5DrinkLargePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.largePrice!)
        ...
        MenuController.shared.fetchImage(urlString: imageUrl!) { result in
            ...
            case .success(let image):
                DispatchQueue.main.async {
                    cell.menu5DrinkImageView.image = image
                }
